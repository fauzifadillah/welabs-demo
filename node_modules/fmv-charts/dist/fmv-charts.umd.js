(function (global, factory) {
	...
	(global = global || self, factory(global.FmvCharts = {}));
	...
	*/
	...
	var chartMixin = {
	  ...
	  computed: {
	    ...
	    prefixAndSuffixOptions: function prefixAndSuffixOptions() {
	      var prefix = this.prefix || '';
	      var suffix = this.suffix || '';
	      var isDoughnut = this.isDoughnut;
	      var isRadar = this.isRadar;
	      var yAxes = isDoughnut || isRadar ? [] : [{
	        ticks: {
	          callback: function callback(a) {
	      ...
	      return {
	        ...
	        tooltips: {
	          callbacks: {
	            label: function label(a, e) {
	              var label = e.datasets[a.datasetIndex].label || '';
	              var value = isDoughnut ? e.datasets[0].data[a.index] : a.yLabel;
	              /*eslint-disable*/

	              if (e.datasets.length) {
	                return "\n                  <span class=\"popover-body-label mr-auto\">".concat(label, "</span>\n                  <span class=\"popover-body-value\">").concat(prefix).concat(value).concat(suffix, "</span>\n                ");
	              }
	            }
	          }
	        }
	    ...
	    chartOptions: function chartOptions() {
	      return objectAssignDeep({}, globalSettings, this.prefixAndSuffixOptions, this.localOptions, this.options);
	    }
	  },
	      ...
	      return {
	        ...
	        legendCallback: function legendCallback(a) {
	          ...
	          o.labels.forEach(function (a, e) {
	            r += "\n              <span class=\"chart-legend-item\">\n                <i class=\"chart-legend-indicator\" style=\"background-color: ".concat(o.datasets[0].backgroundColor[e], "\"></i> ").concat(a, "\n              </span>\n            ");
	          });
	          return r;
	        }
	      };
	...
	var RoundedBar = generateChart('rounded-bar', 'roundedBar');
	var script$3 = {
	  extends: RoundedBar,
	  mixins: [chartMixin],
	  computed: {
	...
	exports.FmvAreaChart = __vue_component__;
	exports.FmvBarChart = __vue_component__$3;
	exports.FmvDoughnutChart = __vue_component__$2;
	exports.FmvLineChart = __vue_component__$1;
	exports.FmvRadarChart = __vue_component__$4;
	exports.fmvChartMixin = chartMixin;
